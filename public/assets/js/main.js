(function ($) {
    ...
    $(window).on('scroll', function(event) {
        ...
        if (scroll <= 100) {
            ...
            $(".header-sticky .header-main-04 .header-logo img, .header-sticky .header-main-05 .header-logo img").attr("src", "{{ asset('') }}assets/images/light-logo.png");
        } else{
            $(".header-sticky").addClass("sticky");
            $(".header-sticky .header-main-04 .header-logo img, .header-sticky .header-main-05 .header-logo img").attr("src", "{{ asset('') }}assets/images/dark-logo.png");
        }
	});
