            ...
            <div class="col-lg-8">
                ...
                <div class="tutor-course-top-info">
                    ...
                    <div class="tutor-course-top-info__content">
                        ...
                        <h1 class="tutor-course-top-info__title">Mastering Data Modeling Fundamentals</h1>
                        <div class="tutor-course-top-info__meta">
                            <div class="tutor-course-top-info__meta-instructor">
                                <div class="instructor-avatar">
                                    <img src="{{ asset('') }}assets/images/instructor/instructor-01.jpg" alt="Instructor" width="36"
                                      height="36">
                                </div>
                                <div class="instructor-name">Owen Christ</div>
                            </div>
                    ...
                    <div class="tutor-course-top-info__video-02 mt-6">
                        <div class="ratio ratio-16x9">
                            <iframe src="https://www.youtube.com/embed/tXr3wCyBE9I" title="YouTube video"
                ...
                <div class="tutor-course-tabs tutor-course-tabs-02 bg-color-13 mt-6">
                    <ul class="nav justify-content-center">
                        ...
                        <li><button data-bs-toggle="tab" data-bs-target="#tab2">Curriculum</button></li>
                        <li><button data-bs-toggle="tab" data-bs-target="#tab3">Instructors</button></li>
                    </ul>
                </div>
                        ...
                        <div class="tutor-course-main-segment">
                                        ...
                                        <li>
                                            <a class="prerequisites-item" href="#">
                                                <div class="prerequisites-item__thumbnail">
                                                    <img src="{{ asset('') }}assets/images/courses/courses-36.jpg" alt="Courses"
                                                      width="70" height="47">
                                                </div>
                            ...
                            <div class="tutor-course-segment">
                                ...
                                <div class="tutor-course-segment__content-wrap">
                                    <p>In this course, I take you from the fundamentals and concepts of data modeling
                                        all the way through a number of best practices and techniques that you’ll need
                                        to build data models in your organization. You’ll find many examples that
                                        clearly demonstrate the key concepts and techniques covered throughout the
                                        course.</p>
                                    <p>By the end of the course, you’ll be all set to not only put these principles to
                                        work, but also to make the key data modeling and design decisions required by
                                        the “art” of data modeling that transcend the nuts-and-bolts techniques and
                                        design patterns.</p>
                                    <p>Organisations, or groups of organisations, may establish the need for master data
                                        management when they hold more than one copy of data about a business entity.
                                        Holding more than one copy of this master data inherently means that there is an
                                        inefficiency in maintaining a “single version of the truth” across all copies.
                                        Unless people, processes and technology are in place to ensure that the data
                                        values are kept aligned across all copies, it is almost inevitable that
                                        different versions of information about a business entity will be held.</p>
                                </div>
                            ...
                            <div class="tutor-course-segment benefits-wrap">
                                ...
                                <div class="tutor-course-segment__benefits-items">
                                    ...
                                    <div class="tutor-course-segment__benefit-item">
                                        <div class="tutor-course-segment__benefit-content">
                                            <i class="fas fa-check"></i>
                                            <span class="benefit-text">Expanded responsibilities as part of an existing
                                                role</span>
                                        </div>
                                    </div>
                                    <div class="tutor-course-segment__benefit-item">
                            ...
                            <div class="tutor-course-segment">
                                ...
                                <div class="tutor-course-segment__requirements-content">
                                    <ul class="tutor-course-segment__list-style-01">
                                        <li>Basic understanding of data management concepts and constructs such as
                                            relational database tables</li>
                                        <li>Know how different pieces of data logically relate to one another.</li>
                                    </ul>
                                </div>
                            ...
                            <div class="tutor-course-segment audience-wrap">
                                ...
                                <div class="tutor-course-segment__audience-content">
                                    <ul class="tutor-course-segment__list-style-02">
                                        ...
                                        <li>Who desires to build a personal toolbox of data modeling best practices and
                                            techniques.</li>
                                    </ul>
                                </div>
                                <!-- Tutor Course Segment Requirements Items End -->
                                ...
                                <div class="course-curriculum accordion">
                                    ...
                                    <div class="accordion-item">
                                        <button class="accordion-button" data-bs-toggle="collapse"
                                          data-bs-target="#collapseOne"> <i class="tutor-icon"></i> IT
                                            background</button>
                                    ...
                                    <div class="accordion-item">
                                        <button class="accordion-button collapsed" data-bs-toggle="collapse"
                                          data-bs-target="#collapseTwo"> <i class="tutor-icon"></i> Key
                                            concepts</button>
                                    ...
                                    <div class="accordion-item">
                                        <button class="accordion-button collapsed" data-bs-toggle="collapse"
                                          data-bs-target="#collapseThree"> <i class="tutor-icon"></i> Apply the
                                            principles</button>
                                ...
                                <div class="tutor-course-segment__instructor">
                                    <div class="tutor-instructor">
                                        <div class="tutor-instructor__avatar">
                                            <img src="{{ asset('') }}assets/images/team/team-member-07.jpg" alt="instructor"
                                    ...
                                    <ul class="comment-list-02">
                                            ...
                                            <div class="comment-item-02">
                                                <div class="comment-item-02__header">
                                                    <div class="comment-item-02__author">
                                                        <img src="{{ asset('') }}assets/images/avatar/avatar-02.jpg" alt="Avatar"
                                                          width="52" height="52">
                                                    </div>
                                        ...
                                        <li>
                                            <div class="comment-item-02">
                                                <div class="comment-item-02__header">
                                                    <div class="comment-item-02__author">
                                                        <img src="{{ asset('') }}assets/images/avatar/avatar-04.jpg" alt="Avatar"
                                                          width="52" height="52">
                                                    </div>
                                                    <div class="comment-item-02__info">
                ...
                <div class="tutor-course-sidebar sidebar-label">
                    ...
                    <div class="tutor-course-price-preview">
                        ...
                        <div class="tutor-course-price-preview__btn">
                            <button class="btn btn-primary btn-hover-secondary w-100"> <i
                    ...
                    <div class="sidebar-widget">
                        ...
                        <div class="sidebar-widget__course">
                            ...
                            <div class="sidebar-widget__course-item">
                                <div class="sidebar-widget__course-thumbnail">
                                    <a href="course-single-layout-01.html"><img
                                          src="{{ asset('') }}assets/images/courses/courses-21.jpg" alt="Courses" width="120"
                                          height="72"></a>
                                </div>
                                <div class="sidebar-widget__course-content">
                                    <h4 class="sidebar-widget__course-title"><a
                                          href="course-single-layout-01.html">Artificial Intelligence: Reinforcement
                                            Learning in Python</a></h4>
                            ...
                            <div class="sidebar-widget__course-item">
                                <div class="sidebar-widget__course-thumbnail">
                                    <a href="course-single-layout-01.html"><img
                                          src="{{ asset('') }}assets/images/courses/courses-15.jpg" alt="Courses" width="120"
                                          height="72"></a>
                                </div>
                                <div class="sidebar-widget__course-content">
                                    <h4 class="sidebar-widget__course-title"><a
                                          href="course-single-layout-01.html">Statistics for Data Science and Business
                                            Analysis</a></h4>
                                    <div class="sidebar-widget__course-price">
                            ...
                            <div class="sidebar-widget__course-item">
                                <div class="sidebar-widget__course-thumbnail">
                                    <a href="course-single-layout-01.html"><img
                                          src="{{ asset('') }}assets/images/courses/courses-33.jpg" alt="Courses" width="120"
                                          height="72"></a>
